...
| **r23** H200–H205（爆炸物）存在但无 GHS01 象形图 | MED | 爆炸物必须使用爆炸弹象形图（GHS01） |
| **r23** H410/H411/H412/H413（环境危害）存在但无 GHS09 象形图 | MED | 环境危害必须使用枯树死鱼象形图（GHS09） |
