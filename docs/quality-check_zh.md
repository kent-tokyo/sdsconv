...
| **r26** H224/H225/H226/H220–H223/H228/H242/H252（易燃）存在但无 GHS02 象形图 | MED | 易燃危险品必须使用火焰象形图（GHS02） |
| **r26** H314（皮肤腐蚀）存在但无 GHS05 象形图 | MED | 腐蚀性危险品必须使用腐蚀象形图（GHS05） |
| **r26** H300/H301/H310/H311/H330/H331（急性毒性 Cat 1–3）存在但无 GHS06 象形图 | MED | 高毒急性毒性必须使用骷髅象形图（GHS06） |
...
| **r26** H314 存在但无脱除污染衣物指示 | MED | P361 要求：需立即脱除污染衣物的指示 |
...
| **r26** | S2-FLAMMABLE-NO-GHS02（MED）：易燃 H 码但无 GHS02 火焰象形图；S2-CORROSIVE-NO-GHS05（MED）：H314 但无 GHS05 腐蚀象形图；S2-ACUTETOX-NO-GHS06（MED）：急性毒性 Cat 1–3 H 码但无 GHS06 骷髅象形图；S4-H314-NO-REMOVE-CLOTHING（MED）：H314 但无 P361 脱除污染衣物指示 |
